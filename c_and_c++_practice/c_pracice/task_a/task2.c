        ...
        double x2, double y2, double w2)
{
    ...
    return (
        /// WRITE HERE
        (((x1<=x2) && ((x1+w1)>=x2) && (y1<=y2) && ((y1+w1)>=y2)) ||
        ((x2<=x1) && ((x2+w2)>=x1) && (y2<=y1) && ((y2+w2)>=y1)) ||
        ((x1<=(x2+w2)) && ((x1+w1)>=(x2+w2)) && (y1<=(y2+w2)) && ((y1+w1)>=(y2+w2))) ||
        ((x2<=(x1+w1)) && ((x2+w2)>=(x1+w1)) && (y2<=(y1+w1)) && ((y2+w2)>=(y1+w1))) ||
        (((x2+w2)>=x1) && ((x2+w2)<=(x1+w1)) && (y2<=(y1+w1)) && ((y2+w2)>=(y1+w1))) ||
        (((x1+w1)>=x2) && ((x1+w1)<=(x2+w2)) && (y1<=(y2+w2)) && ((y1+w1)>=(y2+w2))))
        ///
    );
}
